...
class AppTheme {
  static ThemeData get lightTheme {
    ...
    return base.copyWith(
      ...
      inputDecorationTheme: _inputTheme(AppColors.lightPrimary, AppColors.lightSubtitle),
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith(
          (s) => s.contains(WidgetState.selected) ? AppColors.lightPrimary : Colors.grey.shade400,
        ),
        trackColor: WidgetStateProperty.resolveWith(
          (s) => s.contains(WidgetState.selected) ? AppColors.lightPrimary.withOpacity(0.3) : Colors.grey.shade300,
        ),
      ),
  ...
  static ThemeData get darkTheme {
    ...
    return base.copyWith(
      ...
      inputDecorationTheme: _inputTheme(AppColors.darkPrimary, AppColors.darkSubtitle),
      switchTheme: SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith(
          (s) => s.contains(WidgetState.selected) ? AppColors.darkPrimary : Colors.grey.shade600,
        ),
        trackColor: WidgetStateProperty.resolveWith(
          (s) => s.contains(WidgetState.selected) ? AppColors.darkPrimary.withOpacity(0.35) : Colors.grey.shade800,
        ),
      ),
  ...
  static TextTheme _textTheme(Color main, Color sub) => TextTheme(
        displayLarge: GoogleFonts.poppins(fontSize: 32, fontWeight: FontWeight.w800, color: main),
        displayMedium: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.w700, color: main),
        headlineLarge: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w700, color: main),
        headlineMedium: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.w600, color: main),
        headlineSmall: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.w600, color: main),
        titleLarge: GoogleFonts.poppins(fontSize: 17, fontWeight: FontWeight.w600, color: main),
        titleMedium: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w500, color: main),
        titleSmall: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w500, color: sub),
        bodyLarge: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w400, color: main),
        bodyMedium: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w400, color: main),
        bodySmall: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w400, color: sub),
        labelLarge: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w600, color: main),
        labelSmall: GoogleFonts.poppins(fontSize: 11, fontWeight: FontWeight.w500, color: sub),
      );

  static InputDecorationTheme _inputTheme(Color primary, Color hint) => InputDecorationTheme(
        filled: true,
